...
const WORDS = [
  // Animals (1–60)
  "CAT","DOG","COW","BAT","RAT","OWL","ANT","BEE","FOX","HEN",
  "PIG","BUG","FROG","FISH","GOAT","DEER","LION","BEAR","WOLF","DUCK",
  "CRAB","SEAL","MULE","COLT","SWAN","MOLE","SHARK","HORSE","ZEBRA","SNAKE",
  "PANDA","KOALA","TIGER","MONKEY","DONKEY","RABBIT","KITTEN","PUPPY","CHICK","CALF",
  "EAGLE","OTTER","WHALE","DOLPHIN","CAMEL","GECKO","LLAMA","MOUSE","TURTLE","LOBSTER",
  "PARROT","SPIDER","HAMSTER","GORILLA","LEOPARD","BUFFALO","CHIMP","PEACOCK","RACCOON","HIPPO",

  // Objects (61–120)
  "BOOK","BALL","HAT","BAG","CUP","PEN","BOX","KEY","MAP","RUG",
  "BED","FORK","SPOON","PLATE","CLOCK","DOOR","CHAIR","TABLE","SHOE","SOCK",
  "BELL","TOY","DRUM","BRUSH","COMB","MIRROR","LAMP","PHONE","RADIO","SCREEN",
  "BOTTLE","BUCKET","HAMMER","NAIL","ROPE","TAPE","SCISSOR","PENCIL","ERASER","MARKER",
  "WALLET","CAMERA","REMOTE","KEYBOARD","MOUSE","MONITOR","SPEAKER","HEADSET","CABLE","PLUG",

  // Nature (121–180)
  "SUN","MOON","STAR","SKY","RAIN","WIND","SNOW","ICE","FIRE","LEAF",
  "TREE","ROCK","SAND","SOIL","HILL","LAKE","RIVER","CLOUD","STORM","FIELD",
  "GRASS","FLOWER","PLANT","ROOT","BARK","SEED","STONE","WAVE","SHELL","CORAL",
  "ISLAND","FOREST","MOUNTAIN","VOLCANO","DESERT","OCEAN","GLACIER","VALLEY","CLIFF","CANYON",
  "BREEZE","FOG","DEW","FROST","THUNDER","LIGHT","RAINBOW","SHADOW","EMBER","ASH",

  // Actions (181–240)
  "RUN","JUMP","WALK","HOP","CLAP","TURN","STOP","GO","PUSH","PULL",
  "LIFT","DROP","THROW","CATCH","HOLD","ROLL","SWIM","DIVE","FLY","CRAWL",
  "KICK","HIT","BEND","STAND","SIT","LOOK","SEE","WATCH","LISTEN","HEAR",
  "SMELL","TASTE","TOUCH","DRAW","WRITE","READ","COUNT","BUILD","STACK","MOVE",
  "OPEN","CLOSE","CUT","PASTE","MATCH","SORT","FIND","POINT","TRACE","PRESS",

  // Food (241–300)
  "RICE","BREAD","CAKE","MILK","EGG","FISH","MEAT","SOUP","APPLE","GRAPE",
  "PEAR","PLUM","MANGO","BERRY","LEMON","LIME","PEACH","BANANA","ORANGE","CARROT",
  "BEANS","CORN","ONION","GARLIC","CHEESE","BUTTER","YOGURT","HONEY","SUGAR","SALT",
  "PIZZA","PASTA","NOODLE","BURGER","FRIES","STEAK","CHICKEN","SAUSAGE","TACO","SUSHI",
  "COOKIE","BISCUIT","MUFFIN","DONUT","PANCAKE","WAFFLE","CEREAL","OAT","RICEBALL","TOAST",

  // Simple concepts (301–365)
  "BIG","SMALL","FAST","SLOW","HOT","COLD","HARD","SOFT","LOUD","QUIET",
  "HAPPY","SAD","FUN","PLAY","WORK","REST","DAY","NIGHT","LIGHT","DARK",
  "UP","DOWN","LEFT","RIGHT","IN","OUT","OPEN","CLOSE","START","END",
  "FIRST","LAST","EARLY","LATE","SAME","DIFF","FULL","EMPTY","NEAR","FAR",
  "GOOD","BAD","SAFE","RISK","TRUE","FALSE","YES","NO","MORE","LESS",
  "EVEN","ODD","ORDER","CHAOS","CALM","STRESS","FOCUS","THINK","IDEA","LOGIC",
  "PLAN","GOAL","TRY","WIN","LOSE"
];
